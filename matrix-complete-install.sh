...
Environment variables:
  ...
  ELEMENT_DEFAULT_ESS_HELM_RELEASE       Default ESS helm release (for version mapping).
  ELEMENT_DEFAULT_VERSION                Default Element version request.
...
run_element() {
  ...
  ELEMENT_DEFAULT_ESS_HELM_RELEASE="$DEFAULT_ESS_HELM_RELEASE" \
  ELEMENT_DEFAULT_VERSION="$DEFAULT_ELEMENT_VERSION" \
